...
```
    ...
    ## [1014,] "Clostridiales"       "Ruminococcaceae"                  
...
![](Analysis_Report_01_amplicons_files/figure-markdown_github/Genus-in-Propionibacteriaceae_Family-barplot-1.png) **Figure4**: Genus abundance in Propionibacteriaceae family on M2, M3, M9. For all three male individuals M2, M3, M9, the most common Genus identified on both their keyboards and fingertip is Propionibacterium. For individual M3 and M9, the most adundance on found on Fingertip. For each of the individual, there is a different distrubution of amount of Genus Propionibacterium found on each of the keys.
