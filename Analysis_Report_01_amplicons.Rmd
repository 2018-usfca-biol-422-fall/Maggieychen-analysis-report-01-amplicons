...
```{r}
# what are the most commonly found taxa
plot_tree(phyloseq_obj,
          color = "sample_type",
          ladderize = TRUE)
```
...
```{r}
plot_bar(phyloseq_obj, x="sample_type", fill ="Phylum")
```


```{r}
plot_bar(phyloseq_obj, "Phylum", fill="Phylum", facet_grid=~host_subject_id)
```
```{r}
